...
export async function buildSystemOverview() {
  ...
  return {
    ...
    featureFlags: {
      codemagenEnabled,
      codemagenNote:
        'Redis-backed global toggle. Off = legacy or Codemagen-company tickets stay hidden, Codemagen users stay hidden, and new Codemagen ingestion/sync endpoints reject requests.',
    },
    infrastructureNote:
